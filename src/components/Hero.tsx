  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        Merge and de-identify endoscopic videos with confidence.<br />
        Endoshare removes out-of-body scenes and file metadata to improve sharing 
        for clinical education and collaboration.
        </p>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground">
          De-identify content to meet medical privacy standards*
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground">
          Enable collaboration and education in the clinical community
          </p>
        </div>
        </div>
      </div>
      <div className="mt-12 text-center">
        <p className="text-sm text-muted-foreground">
          *While our system applies state-of-the-art methods, it is not formally certified; for full privacy assurance, manual review is recommended.
        </p>
      </div>
      </div>
    </section>
